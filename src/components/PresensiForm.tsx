...
export const PresensiForm = () => {
  ...
  const startCamera = useCallback(async () => {
    ...
    console.log("cameraOpen", cameraModalOpen);
  ...
  const stopCamera = useCallback(() => {
    ...
    //lepas source dari elemen video
    if (videoRef.current) {
  ...
  const cekConsole = () => {
    ...
    console.log(cameraStartedRef);
    console.log(cameraStartedRef.current);
    console.log(detectionsRef);
